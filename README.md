...
- Company code challenges are sometimes split into different sections, potentially each being weighted differently in terms of points, but these weightings are left opaque to the applicant
